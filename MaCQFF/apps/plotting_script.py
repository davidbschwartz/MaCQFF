...
path = "MaCQFF/experiments/GP/environments/"
k = open(path + "/0_env_data.pkl", "rb")
filename = 'macqff-coverage'
CUTOFF_SIZE = 200


def set_label(label):
    if label == "smcc_MaCQFF":
        return "MaCQFF", "tab:orange"
...
plt.savefig("cov_reco_Rbar0.pdf")
plt.close()
#plt.show()
