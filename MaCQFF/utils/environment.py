...
# import sys
# print(sys.path)
# from openweathermap.KGS_environment import (GridFunction, get_gorillas_density, get_jungle_weather) # TODO: uncomment
...
class GridWorld:
    ...
    def __init__(self, env_params, common_params, env_dir) -> None:
        ...
        if env_params["generate"] == True:
            ...
            print("error: using gorilla instead of synthetic data")
            # TODO: uncomment
...
if __name__ == "__main__":
    workspace = "MaCQFF"
    with open(workspace + "/params/smcc_MaCQFF.yaml") as file:
    ...
    if params["env"]["generate"]:
        ...
        env_load_path = (
            workspace + "/experiments/GP/environments/env_" +
            str(0) + "/"
        )
